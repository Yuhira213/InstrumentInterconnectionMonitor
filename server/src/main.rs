...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let influx_url = "http://localhost:8086/api/v2/write?org=YuhirAnanda&bucket=ISIMonitor&precision=s";
    let token = "vnuy0602g8wXoE1eT9jTBhh5jsb4aoRdpv71HPuh2iN-_xNF5qNzU3kcAwIQQcbPMBVCsD4D3m9gLHOTmFgyzA==";
